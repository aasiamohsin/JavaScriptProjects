...
function searchMeal(e) {
    ...
    if(term.trim()) {
        ...
        .then(data => {
            ...
            if(data.meals === null) {
                resultHeading.innerHTML = `<p>There are no search results for '${term}', please try different search.</p>`
            }else {
...
// Event listener on clicking on a meal
...
randomBtn.addEventListener('click', e => {
    ...
    .then(data => {
        ...
        const singleRandomMeal = data.meals[0]
        console.log(singleRandomMeal);

        addMealToDOM(singleRandomMeal);
