...
// Generate a word from wordlist
function generateRandomWord() {
    return wordList[ Math.floor(Math.random() * wordList.length)];
}

// On page load focus on input field
textElement.focus();

// Start countdown
const timeInterval = setInterval( updateTime, 1000 );
    
// Function to add the random word to DOM
...
function updateTime() {
    ...
    if( time === 0 ){
        ...
        // Stop countdown at 0s
        clearInterval(timeInterval)

        // End the game and shows end game container
        gameOver();
    }
}
...
// 2. Event listener on settings button
